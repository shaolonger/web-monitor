...
class WidgetLogChartResourceType extends StatefulWidget {
  final List<dynamic> chartData;

  WidgetLogChartResourceType(this.chartData);

  @override
  _WidgetLogChartResourceTypeState createState() =>
      _WidgetLogChartResourceTypeState();
}

class _WidgetLogChartResourceTypeState extends State<WidgetLogChartResourceType> {
  final String _title = "资源类型";
  int _touchedIndex;
