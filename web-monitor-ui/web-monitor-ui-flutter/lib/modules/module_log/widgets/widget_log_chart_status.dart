...
class WidgetLogChartStatus extends StatefulWidget {
  final List<dynamic> chartData;

  WidgetLogChartStatus(this.chartData);

  @override
  _WidgetLogChartStatusState createState() =>
      _WidgetLogChartStatusState();
}

class _WidgetLogChartStatusState extends State<WidgetLogChartStatus> {
  final String _title = "状态码";
  int _touchedIndex;
