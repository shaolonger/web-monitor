...
class WidgetLogChartOs extends StatefulWidget {
  final List<dynamic> chartData;

  WidgetLogChartOs(this.chartData);

  @override
  _WidgetLogChartOsState createState() =>
      _WidgetLogChartOsState();
}

class _WidgetLogChartOsState extends State<WidgetLogChartOs> {
  final String _title = "操作系统";
  int _touchedIndex;
