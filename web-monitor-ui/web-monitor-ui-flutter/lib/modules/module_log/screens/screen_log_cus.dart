...
class ScreenLogCus extends StatefulWidget {
  ...
  @override
  _ScreenLogCusState createState() => _ScreenLogCusState();
}

class _ScreenLogCusState extends State<ScreenLogCus> {
  final String _logType = ConstLog.LOG_TYPE_LIST_MAP["CUS"];
  ...
  void _getOverviewData() async {
    ...
    List<dynamic> result = model.customErrorLog;
  ...
  void _getChartOverviewData() async {
    ...
    List<dynamic> chartData = model.customErrorLog;
    setState(() {
  ...
  @override
  void didUpdateWidget(covariant ScreenLogCus oldWidget) {
